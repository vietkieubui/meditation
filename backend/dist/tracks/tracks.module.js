...
const tracks_schema_1 = require("./tracks.schema");
let TracksModule = class TracksModule {
};
TracksModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: tracks_schema_1.Tracks.name, schema: tracks_schema_1.TracksSchema }]),
        ],
        providers: [tracks_resolver_1.TracksResolver, tracks_service_1.TracksService],
    })
], TracksModule);
